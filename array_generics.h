...
\
void GEN_FUNC_NAME(init, name) ## (FSD_ARRAY_TYPE(name)* array, size_t initial_size); \
void GEN_FUNC_NAME(free, name) ## (FSD_ARRAY_TYPE(name)* array); \
void GEN_FUNC_NAME(insert, name) ## (FSD_ARRAY_TYPE(name)* array, type value);
